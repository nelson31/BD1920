...
# iNSERCAO DOS ATLETAS

INSERT INTO testesclinicos.ATLETA (cc, fName, lName, dataNascimento, nome_Pai, nome_Mae, numContribuinte, codigo_postal, idModalidade, idCategoria, morada, Genero) VALUES (123456, 'Manuel','Marques', '1991-04-22', 'Joao Marques', 'Maria Pinto', 254123686, '4700-001', 1, 1,'Rua de Cima n.º 753, 4.º DTO', 'M');
INSERT INTO testesclinicos.ATLETA (cc, fName, lName, dataNascimento, nome_Pai, nome_Mae, numContribuinte, codigo_postal, idModalidade, idCategoria, morada, Genero) VALUES (652354, 'Miguel','Pereira', '1991-04-22', 'Ricardo Pereira', 'Maria Pinto', 254123687, '4700-001', 2, 1,'Rua da Oliveira n.º 753, 4.º DTO', 'M');
INSERT INTO testesclinicos.ATLETA (cc, fName, lName, dataNascimento, nome_Pai, nome_Mae, numContribuinte, codigo_postal, idModalidade, idCategoria, morada, Genero) VALUES (125478, 'Manuela','Silva', '1991-04-22', 'Joao Silva', 'Maria Pinto', 254123681, '4700-001', 5, 2,'Rua do Rio n.º 753, 4.º DTO', 'F');
INSERT INTO testesclinicos.ATLETA (cc, fName, lName, dataNascimento, nome_Pai, nome_Mae, numContribuinte, codigo_postal, idModalidade, idCategoria, morada, Genero) VALUES (525252, 'Manuel','Oliveira', '1991-04-22', 'Joaquim Oliveira', 'Maria Pinto', 254123685, '4700-001', 9, 2,'Rua Grande n.º 753, 4.º DTO', 'M');
INSERT INTO testesclinicos.ATLETA (cc, fName, lName, dataNascimento, nome_Pai, nome_Mae, numContribuinte, codigo_postal, idModalidade, idCategoria, morada, Genero) VALUES (145263, 'Manuel','Tinoco', '1991-04-22', 'Antonio Tinoco', 'Maria Pinto', 254123683, '4700-001', 8, 1,'Rua de Cima n.º 753, 4.º DTO', 'M');
INSERT INTO testesclinicos.ATLETA (cc, fName, lName, dataNascimento, nome_Pai, nome_Mae, numContribuinte, codigo_postal, idModalidade, idCategoria, morada, Genero) VALUES (124789, 'Manuel','Joao', '1991-04-22', 'Duarte Joao', 'Maria Pinto', 254123684, '4700-001', 11, 1,'Rua do Sul n.º 753, 4.º DTO', 'M');
INSERT INTO testesclinicos.ATLETA (cc, fName, lName, dataNascimento, nome_Pai, nome_Mae, numContribuinte, codigo_postal, idModalidade, idCategoria, morada, Genero) VALUES (164821, 'José','Pires', '1999-04-14', 'Carlos Silva', 'Patrícia Matos', 256147659, '4700-004', 14, 1,'Rua de Baixo n.º 26', 'M');
INSERT INTO testesclinicos.ATLETA (cc, fName, lName, dataNascimento, nome_Pai, nome_Mae, numContribuinte, codigo_postal, idModalidade, idCategoria, morada, Genero) VALUES (178511, 'António','Silva', '1997-03-12', 'Francisco Silva', 'Francisca Silva', 256785657, '4700-003', 13, 2,'Rua da Esquerda n.º 28', 'M');
INSERT INTO testesclinicos.ATLETA (cc, fName, lName, dataNascimento, nome_Pai, nome_Mae, numContribuinte, codigo_postal, idModalidade, idCategoria, morada, Genero) VALUES (164822, 'José','Creissac', '1985-12-19', 'Luis Creissac', 'Ana Fernandes', 257564231, '4700-001', 5, 1,'Rua da Liberdade n.º 50', 'M');
INSERT INTO testesclinicos.ATLETA (cc, fName, lName, dataNascimento, nome_Pai, nome_Mae, numContribuinte, codigo_postal, idModalidade, idCategoria, morada, Genero) VALUES (198465, 'Guilherme','Fernandes', '1984-11-19', 'Luis Fernandes', 'Cátia Fernandes', 257564457, '8700-513', 17, 1,'Rua do Poço n.º 12', 'M');
INSERT INTO testesclinicos.ATLETA (cc, fName, lName, dataNascimento, nome_Pai, nome_Mae, numContribuinte, codigo_postal, idModalidade, idCategoria, morada, Genero) VALUES (568468, 'Daniel','Santos', '1986-12-17', 'Marco Santos', 'Mariana Santos', 257564897, '8700-513', 5, 1,'Rua da Prata n.º 56', 'M');
INSERT INTO testesclinicos.ATLETA (cc, fName, lName, dataNascimento, nome_Pai, nome_Mae, numContribuinte, codigo_postal, idModalidade, idCategoria, morada, Genero) VALUES (981651, 'Paulo','Braz', '1995-05-09', 'Diogo Braz', 'Catarina Ramos', 257564987, '4720-448', 17, 2,'Rua do Sapateiro n.º 12', 'M');
INSERT INTO testesclinicos.ATLETA (cc, fName, lName, dataNascimento, nome_Pai, nome_Mae, numContribuinte, codigo_postal, idModalidade, idCategoria, morada, Genero) VALUES (161648, 'José','Esteves', '1999-06-01', 'Victor Silva', 'Ana Esteves', 257564456, '4720-448', 16, 2,'Avenida Fernando Pessoa n.º 11', 'M');
INSERT INTO testesclinicos.ATLETA (cc, fName, lName, dataNascimento, nome_Pai, nome_Mae, numContribuinte, codigo_postal, idModalidade, idCategoria, morada, Genero) VALUES (111235, 'João','Lopes', '1997-03-19', 'Luis Costa', 'Lara Lira', 257564496, '1300-472', 4, 1,'Rua da Igreja n.º 2', 'M');
INSERT INTO testesclinicos.ATLETA (cc, fName, lName, dataNascimento, nome_Pai, nome_Mae, numContribuinte, codigo_postal, idModalidade, idCategoria, morada, Genero) VALUES (112654, 'Francisco','Fernandes', '1989-01-12', 'Joaquim Fernandes', 'Rita Oliveira', 25756134, '1300-472', 5, 1,'Rua Nova n.º 55', 'M');
INSERT INTO testesclinicos.ATLETA (cc, fName, lName, dataNascimento, nome_Pai, nome_Mae, numContribuinte, codigo_postal, idModalidade, idCategoria, morada, Genero) VALUES (131684, 'Rodrigo','Tinoco', '1989-01-10', 'Luis Jesus', 'Ana Iglésias', 25897456, '4700-001', 15, 1,'Rua da Feira n.º 3', 'M');
INSERT INTO testesclinicos.ATLETA (cc, fName, lName, dataNascimento, nome_Pai, nome_Mae, numContribuinte, codigo_postal, idModalidade, idCategoria, morada, Genero) VALUES (164898, 'Rui','Matos', '1996-12-22', 'João Matos', 'Ivone Matos', 25754212, '1300-472', 9, 1,'Rua da Graça n.º 4', 'M');
INSERT INTO testesclinicos.ATLETA (cc, fName, lName, dataNascimento, nome_Pai, nome_Mae, numContribuinte, codigo_postal, idModalidade, idCategoria, morada, Genero) VALUES (166165, 'Luis','Rodrigues', '1996-08-26', 'José Rodrigues', 'Marta Fernandes', 25751347, '1300-472', 7, 1,'Rua do Ribeiro n.º 6', 'M');
INSERT INTO testesclinicos.ATLETA (cc, fName, lName, dataNascimento, nome_Pai, nome_Mae, numContribuinte, codigo_postal, idModalidade, idCategoria, morada, Genero) VALUES (122165, 'Rui','Ferreira', '1994-07-30', 'Paulo Ferreira', 'Mónica Ferreira', 25918754, '4730-062', 11, 1,'Rua dos Bombeiros n.º 71', 'M');
INSERT INTO testesclinicos.ATLETA (cc, fName, lName, dataNascimento, nome_Pai, nome_Mae, numContribuinte, codigo_postal, idModalidade, idCategoria, morada, Genero) VALUES (131614, 'Rafael','Lopes', '1999-05-22', 'Miguel Lopes', 'Joana Lopes', 25753252, '4730-062', 12, 1,'Rua da Liberdade n.º 20', 'M');
INSERT INTO testesclinicos.ATLETA (cc, fName, lName, dataNascimento, nome_Pai, nome_Mae, numContribuinte, codigo_postal, idModalidade, idCategoria, morada, Genero) VALUES (112211, 'Rosa','Marques', '2000-07-21', 'Marco Marques', 'Mariana Marques', 21189871, '3750-100', 01, 1,'Rua da Água n.º 24', 'F');
INSERT INTO testesclinicos.ATLETA (cc, fName, lName, dataNascimento, nome_Pai, nome_Mae, numContribuinte, codigo_postal, idModalidade, idCategoria, morada, Genero) VALUES (115646, 'Rafaela','Luz', '2001-04-15', 'Miguel Luz', 'Ana Luz', 21116125, '3800-378', 11, 1,'Rua do Fogo n.º 78', 'F');
INSERT INTO testesclinicos.ATLETA (cc, fName, lName, dataNascimento, nome_Pai, nome_Mae, numContribuinte, codigo_postal, idModalidade, idCategoria, morada, Genero) VALUES (118798, 'Matilde','Fidalgo', '1981-05-14', 'Luis Fidalgo', 'Júlia Fernandes', 21111111, '3800-378', 15, 1,'Rua da Pedreira n.º 27', 'F');
INSERT INTO testesclinicos.ATLETA (cc, fName, lName, dataNascimento, nome_Pai, nome_Mae, numContribuinte, codigo_postal, idModalidade, idCategoria, morada, Genero) VALUES (118984, 'Matilde','Lopes', '1985-09-06', 'Abel Lopes', 'Angélica Lopes', 21123254, '3800-378', 06, 1,'Rua da Fonte n.º 24', 'F');
INSERT INTO testesclinicos.ATLETA (cc, fName, lName, dataNascimento, nome_Pai, nome_Mae, numContribuinte, codigo_postal, idModalidade, idCategoria, morada, Genero) VALUES (116548, 'Ana','Silva', '1999-11-07', 'Daniel Bragança', 'Rita Braga', 21198498, '3040-382', 06, 1,'Rua do Padeiro n.º 84', 'F');
INSERT INTO testesclinicos.ATLETA (cc, fName, lName, dataNascimento, nome_Pai, nome_Mae, numContribuinte, codigo_postal, idModalidade, idCategoria, morada, Genero) VALUES (117985, 'Rita','Morais', '1997-10-22', 'Miguel Morais', 'Sara Morais', 21984654, '4730-062', 04, 1,'Rua da Praia n.º 20', 'F');
INSERT INTO testesclinicos.ATLETA (cc, fName, lName, dataNascimento, nome_Pai, nome_Mae, numContribuinte, codigo_postal, idModalidade, idCategoria, morada, Genero) VALUES (113215, 'Bruna','Barbosa', '1998-12-21', 'Heitor Barbosa', 'Zulmira Barbosa', 21263514, '2765-598', 09, 1,'Rua dos Pescadores n.º 23', 'F');



/* Insercao dos Testes Clínicos*/
INSERT INTO testesclinicos.TESTE_CLINICO (idAtleta, idMedico, data_hora, duracao) VALUES (123456, 123489, '2016-01-23 14:30', '00:15:00');
INSERT INTO testesclinicos.TESTE_CLINICO (idAtleta, idMedico, data_hora, duracao) VALUES (123456, 223456, '2021-08-27 9:30', '00:25:00');
INSERT INTO testesclinicos.TESTE_CLINICO (idAtleta, idMedico, data_hora, duracao) VALUES (652354,  123489, '2015-08-27 9:30', '00:35:00');
INSERT INTO testesclinicos.TESTE_CLINICO (idAtleta, idMedico, data_hora, duracao) VALUES (123456, 223456, '2019-11-27 9:30', '00:25:00');
INSERT INTO testesclinicos.TESTE_CLINICO (idAtleta, idMedico, data_hora, duracao) VALUES (123456, 223456, '2019-12-27 9:30', '00:25:00');
INSERT INTO testesclinicos.TESTE_CLINICO (idAtleta, idMedico, data_hora, duracao) VALUES (123456, 223456, '2019-12-01 9:30', '00:25:00');
INSERT INTO testesclinicos.TESTE_CLINICO (idAtleta, idMedico, data_hora, duracao) VALUES (123456, 223456, '2019-12-03 9:30', '00:25:00');
INSERT INTO testesclinicos.TESTE_CLINICO (idAtleta, idMedico, data_hora, duracao) VALUES (123456, 223456, '2019-12-03 23:50', '00:25:00');
